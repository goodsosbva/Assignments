<template>
  <Subpage :pagetit="'회사 소개'" class="subPageMain">
    <div class="company">
      <div class="introcon">
        <div class="introgroup">
          <strong><i class="bi bi-people-fill"></i> “사람을 구체적으로 도와주는 책”</strong>
          <p>
            이지스퍼블리싱(주)의 책에는 ‘사람들에게 구체적으로 도움이 되는 책’을 만든다는 출판
            가치가 담겨 있습니다.<br />
            2010년 5월 출범한 이지스퍼블리싱(주)는 크게 두 영역의 책을 출간합니다. IT 실용 도서와
            학습 분야 도서입니다.<br />
            IT 교재와 사진 책 등 실용서는 이지스퍼블리싱 브랜드로, 학습과 자녀교육 도서는 이지스에듀
            브랜드로 출간하고 있습니다.
          </p>
        </div>
        <div class="introgroup">
        ...
        <div class="introgroup">
          ...
          <p>
            ...
            기여한 바, 공정한 분배가 이루어지고 영광을 함께 나누는 곳. 그곳이 바로
            이지스퍼블리싱(주)입니다.
          </p>
        </div>
      </div>
