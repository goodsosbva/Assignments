      ...
      <template v-else-if="tapselect == 'review'">
        <div class="detailTapCon">
          ...
          <p>
            ...
            - Do it! 스터디룸 카페 [cafe.naver.com/doitstudyroom → ‘Do it! 공부단 지원&책 선물 받기’
            메뉴]<br />
          </p>
        </div>
      </template>
      ...
      <template v-else-if="tapselect == 'write'">
        <div class="detailTapCon">
          ...
          <p>
            ...
            13년 차 웹 퍼블리셔이다. 국내 웹 에이전시에서 활동하며 이니스프리, 에뛰드, 엘지 하우시스
            등 유명한 쇼핑몰 제작에 참여했고 그동안 작업한 사이트 대부분은 웹 어워드 코리아에서 각
            분야별로 최우수상 또는 대상을 수상하였다. 또한 웹 퍼블리싱 실무 강의로 인기를 끌기도
            했다. 'Do it! 웹 사이트 따라 만들기'는 그녀의 실무 경험과 강의 경험이 결합되어 나온
            책이다. 그녀의 업무 방식을 화면 그대로 정리해 이 책에 빠짐없이 옮겨 담았으며 이 책을
            읽는 독자들의 시간을 절약해주기 위해 전체 소스도 공개했다. 이 소스를 그대로 활용하면
            독자가 필요한 웹사이트를 빠르게 만들 수 있다. 그녀는 현재 외국계 기업에서 솔루션
            프로그램을 만드는 프로젝트에 참여하고 있다.
          </p>
        </div>
      </template>
