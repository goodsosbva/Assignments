  ...
  <section class="bookdetail">
    ...
    <div class="book-info">
      <div class="imgview">
        ...
        <div class="bookbtns">
          <b-button variant="lightgray"><i class="bi bi-search"></i>책 미리보기</b-button>
          <b-button variant="lightgray"><i class="bi bi-hdd"></i>전자책</b-button>
        </div>
      </div>
      <div class="infolist">
        <ul>
      ...
      <template v-if="tapselect == 'introduce'">
        <div class="detailTapCon">
          ...
          <p>
            ...
            이 책은 기본이 충실하면서도 프로젝트 실습까지 챙긴 C# 입문서입니다. C#에 빠르게 입문하여
            활용할 수 있게 구성했습니다. 방대하고 어려운 문법에 매몰되지 않도록 자주 사용하는 핵심
            기능에 집중했으며, 윈도우 앱과 웹 서비스, 게임은 물론 사물 인터넷까지 각 분야에서 C#을
            어떻게 활용하는지 4가지 프로젝트로 실습해 봅니다. 또한 책의 전체 과정을 상세하게 소개한
            영상 강의로 학습을 돕고, 저자가 운영하는 커뮤니티에서는 책을 보충하는 다양한 콘텐츠로
            독자와 만납니다.
          </p>
        </div>
      </template>
      <template v-else-if="tapselect == 'review'">
        <div class="detailTapCon">
          ...
          <p>
            ...
            어떤 개발 언어든지 기본을 충실하게 배워 두면 다양한 프로그램을 만들 수 있을 뿐만 아니라
            새로운 언어도 쉽게 배울 수 있습니다. 이 책은 대부분의 언어에서 공통으로 제공하는 문법과
            객체지향 프로그래밍의 핵심을 자세하게 설명하여 기초를 튼튼하게 만들어 줍니다. 또한 C#
            버전별로 추가된 새로운 기능까지 살펴보면서 문법 공부를 보충합니다.
          </p>
          <p>
            ...
            - 웹 기반 개발 도구를 보조 수단으로 제시해 설치 문제가 없습니다. (단, 06~09장 프로젝트
            실습은 제외)
          </p>
        </div>
      </template>
      ...
      <template v-else-if="tapselect == 'write'">
        <div class="detailTapCon">
          ...
          <p>
            ...
            IT 기술을 활용한 메이커 교육 서비스를 제공하는 이누의 대표 입니다. 유니티와 C#을 활용한
            3D 게임, 가상 현실과 증강 현실 콘텐츠를 개발합니다. 또한 아두이노, 라즈베리파이 등
            오픈소스 하드웨어와 3D 모델링, 프린팅으로 사물 인터넷 장치 만들기를 좋아합니다. 누구나
            자신이 필요한 것을 만들 수 있는 메이커가 될 수 있도록 돕고 싶습니다.
            ...
            • SW 마에스트로, 한이음, 프로보노 ICT, 이브와 ICT, 공개 소프트웨어 개발자 대회 멘토로
            활동 <br />
          </p>
        </div>
      </template>
      <template v-else-if="tapselect == 'recommendation'">
        <div class="detailTapCon">
          ...
          <p>
            ...
            이 책은 누구나 무료로 쉽게 구할 수 있는 비주얼 스튜디오 설치와 사용법을 자세하게
            소개합니다. 실습은 대부분 비주얼 스튜디오에서 진행하지만 게임을 만들 때는 유니티, 사물
            인터넷을 만들 때는 온라인 저작 도구인 팅커캐드의 서킷을 이용합니다. 또한 C# 문법을
            공부할 때는 개발 도구를 설치하지 않아도 웹 브라우저에서 바로 실습해 볼 수 있는 온라인
            통합 개발 환경도 소개하여 진입 장벽을 낮췄습니다.
            <br /><br />

            <strong>보기 편한 책으로 ‘꼼꼼하게’ 배워요!</strong><br />

            책에 담긴 주요한 코드마다 주석이나 말풍선으로 해설을 달아 분석에 도움을 주고 실행 결과를
            친절하게 설명합니다. 또한 미니 퀴즈, 도전 코딩을 풀며 배운 내용을 스스로 점검해 볼 수
            있습니다.
          </p>
          <p>
